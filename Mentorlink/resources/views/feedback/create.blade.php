...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        ...
        <form action="{{ route('feedback.store') }}" method="POST" class="bg-white rounded-lg shadow-sm p-6">
            @csrf
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="is_anonymous" class="rounded border-gray-300 text-blue-600 shadow-sm">
                    <span class="ml-2 text-sm text-gray-600">Submit anonymously</span>
                </label>
            </div>

            <div class="flex justify-end space-x-4">
                <a href="{{ route('courses.show', $course->id) }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">
                    Cancel
                </a>
